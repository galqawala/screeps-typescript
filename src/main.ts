...
function getCarrierRoomEnergySource(creep: Creep, minEnergy: number) {
  ...
  return getCarrierEnergySources(room)
    .filter(source => utils.getEnergy(source) >= minEnergy && !utils.isCreepRetrieving(source.id))
    .map(source => ({
      value: source,
...
function getRandomCoolText(): string {
  ...
  let texts = [
    ...
    "'Cause part of me knows what you're thinking. Don't say words you're gonna regret.",
    ...
    "And I don't need to see any more to know that. I can read your mind (Looking at you).",
    ...
    "Don't cry, I ain't changin' my mind. So find another fool like before.",
    "Don't leave false illusion behind.",
    "Don't let the fire rush to your head. I've heard the accusation before.",
    ...
    "I can read your mind. I am the eye in the sky. Looking at you. I can read your mind.",
